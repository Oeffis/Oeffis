// To parse this data:
//
//   import { Convert, LOCATIONSUGGESTSchema, SERVINGLINESSchema, TRIPSchema, DMTTPSchema } from "./file";
//
...
//   const dMTTPSchema = Convert.toDMTTPSchema(json);
//
...
export class Convert {
    ...
    public static toDMTTPSchema(json: string): DMTTPSchema {
        return cast(JSON.parse(json), r("DMTTPSchema"));
    }

    public static dMTTPSchemaToJson(value: DMTTPSchema): string {
        return JSON.stringify(uncast(value, r("DMTTPSchema")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "DMTTPSchema": o([
        ...
        { json: "properties", js: "properties", typ: u(undefined, "any") },
        { json: "serverInfo", js: "serverInfo", typ: u(undefined, r("ServerInfo")) },
        { json: "stopEvents", js: "stopEvents", typ: u(undefined, a(r("StopEvent"))) },
        { json: "systemMessages", js: "systemMessages", typ: u(undefined, a(r("SystemMessage"))) },
        { json: "version", js: "version", typ: "" },
    ], false),
    "StopEvent": o([
        ...
        { json: "departureTimeEstimated", js: "departureTimeEstimated", typ: u(undefined, "") },
        { json: "departureTimePlanned", js: "departureTimePlanned", typ: u(undefined, "") },
        { json: "hiddenLines", js: "hiddenLines", typ: u(undefined, a(r("HiddenLine"))) },
        { json: "hints", js: "hints", typ: u(undefined, a(r("Info"))) },
        { json: "infos", js: "infos", typ: u(undefined, a(r("Info"))) },
        { json: "isRealtimeControlled", js: "isRealtimeControlled", typ: u(undefined, true) },
        { json: "location", js: "location", typ: u(undefined, r("Location")) },
        { json: "onwardLocations", js: "onwardLocations", typ: u(undefined, a(r("Location"))) },
        { json: "previousLocations", js: "previousLocations", typ: u(undefined, a(r("Location"))) },
        { json: "realtimeStatus", js: "realtimeStatus", typ: u(undefined, r("RealtimeTripStatus")) },
        { json: "transportation", js: "transportation", typ: r("Transportation") },
    ], false),
    "HiddenLine": o([
        { json: "destination", js: "destination", typ: u(undefined, r("Location")) },
        { json: "origin", js: "origin", typ: u(undefined, r("Location")) },
