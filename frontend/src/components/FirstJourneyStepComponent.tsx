...
export interface StationProps { key: string, startTime: Date, stationName: string, isFirst: boolean, trackOrigin: string, trackDestination: string, showProgress?: boolean }
