...
import { HistoricDataQueryRunnerService } from "./service/query/historicDataQueryRunner.service";

@Module({
  providers: [HistoricDataService, HistoricDataQueryRunnerService, HistoricDataProcessorService],
  controllers: [],
